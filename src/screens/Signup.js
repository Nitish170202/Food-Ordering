...
export default function Signup() {
    ...
    const [credentials, setcredentials] = useState({ name: "", email: "", password: "",mobilenumber:"", location: "" });
            ...
            <div className='container my-5' style={{ color: "white", fontWeight: "30px" }}>
                <form method='post'>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="number" className="form-control" name='mobile number' value={credentials.mobilenumber} onChange={onChange} />
                    </div>
                    <div className="mb-3">
